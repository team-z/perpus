<div id="sidebar">
			<div id="sidebar-wrapper">
				<div class="sidebar-title"><h2>FunTasting</h2><span>PanelPetugas</span></div>
				<ul class="sidebar-nav">
					...
					<li><a href="#"><i class="fa fa-fw fa-user"></i><span class="nav-label">Anggota</span></a></li>
					<li><a href="#"><i class="fa fa-fw fa-question"></i><span class="nav-label">Tentang</span></a></li>
