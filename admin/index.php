...
<head>
	...
	<style type="text/css">
		.jumbotron{background-color: rgba(255,255,255,0);font-family: 'Raleway',sans-serif;color: white;}
	</style>
</head>
         ...
         <div class="col-md-4">
           ...
           <h1>Login</h1>
         	 <form class="form-horizontal">
               ...
               <div class="form-group">
                <input type="submit" class="btn btn-block btn-lg btn-default" value="Login" name="">
               </div>
         	 </form>
           </div>
         </div>
