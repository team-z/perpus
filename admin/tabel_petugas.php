...
<?php include "navbar.php"; ?>
    ...
    <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <a href="daftar_anggota.html" class="btn btn-lg btn-success"><i class="glyphicon glyphicon-plus"></i> Input Petugas</a><br><br>
                <table class="table table-striped table-bordered">
                    <thead>
                    <tr>
                        <th class="warning"><center>No</center></th>
                        <th class="succes"><center>Foto</center></th>
                        <th class="info"><center>No. Petugas</center></th>
